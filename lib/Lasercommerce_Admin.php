    ...
    public function add_settings( $settings, $current_section=null ) {
        ...
        if( !$current_section ) { //Advanced Pricing and Visibility
            ...
            $settings[] = array(
                ...
                'default' => '[{"name":"Administrator","id":"ADMIN","omniscient":true},{"major":true,"name":"Retail","id":"RN","children":[{"major":true,"name":"Wholesale","id":"WN","children":[{"major":true,"name":"Distributor","id":"DN"}]}]}]'
            );
            $settings[] = array(
                'type' => 'sectionend',
                'id' => 'options'
